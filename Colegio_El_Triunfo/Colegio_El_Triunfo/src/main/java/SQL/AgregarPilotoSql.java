...
public class AgregarPilotoSql extends javax.swing.JFrame {


    
    
    public AgregarPilotoSql() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lbTitulo.setText("Agregar piloto");
        ...
        lbAgregarEstudiante1.setText("Datos del piloto");
        ...
        tfCodigoPiloto.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mousePressed(java.awt.event.MouseEvent evt) {
                tfCodigoPilotoMousePressed(evt);
            }
        });
                        ...
                        .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel2Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(tfCodigoPiloto)
                                    .addComponent(tfNombre, javax.swing.GroupLayout.DEFAULT_SIZE, 306, Short.MAX_VALUE))
                                .addGap(35, 35, 35)
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    ...
    private void btEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEliminarActionPerformed
        //Eliminar
        MetodoPiloto objetoEliminar=new MetodoPiloto();
        objetoEliminar.EliminarPiloto(tfBuscar);
        Limpiar();
    }//GEN-LAST:event_btEliminarActionPerformed

    private void btModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btModificarActionPerformed
        //Modificar
        MetodoPiloto objetoModificar=new MetodoPiloto();
        objetoModificar.Modificar(tfBuscar, tfNombre, tfEdad, tfTelefono);
        Limpiar();
    ...
    private void btBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btBuscarActionPerformed
        ...
        objetoPiloto.BuscarPorCodigoPiloto(tfBuscar, tfCodigoPiloto, tfNombre, tfEdad, tfTelefono);
    ...
    private void btGuardar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btGuardar1ActionPerformed
        ...
        MetodoPiloto objetoPiloto=new MetodoPiloto();
        objetoPiloto.Insertar(tfCodigoPiloto, tfNombre, tfEdad, tfTelefono);
        Limpiar();
    ...
    private void tfBuscarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tfBuscarMouseClicked
        // TODO add your handling code here:
        //Ocultar textfield de codigo de piloto
        tfCodigoPiloto.setEnabled(false);
    }//GEN-LAST:event_tfBuscarMouseClicked

    private void tfCodigoPilotoMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tfCodigoPilotoMousePressed
        // TODO add your handling code here:
        //Volvemos ha activar el textfield de codigo de piloto.
        tfCodigoPiloto.setEnabled(true);
    }//GEN-LAST:event_tfCodigoPilotoMousePressed
